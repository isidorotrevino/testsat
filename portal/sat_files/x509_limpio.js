    ...
    'E65': (function () {
        ...
        return {
            R65: function (u65) {
                ...
                // console['log']('que es ', u65, m65, T65);
                return m65 ? T65 : !T65;
            }
        };
    })(),
...
function X509() {
    ...
    this[g] = function () {
        console['log']('Get key usage ',B1S6.U7K,w8,this[w8])
    ...
    this[Z] = B1S6.E65.R65("1c") ? function () {
        console['log']('Get Tipo Certificado ',B1S6.r0K, B1S6.E65.R65("1c"),w8);
        return X509[B1S6.r0K](this.hex);
    } : "pem shall be not ENCRYPTED";
    this[F] = B1S6.E65.R65("57") ? 97 : function () {
        console['log']('Get RFC ',B1S6.X0K,B1S6.E65.R65("57"),w8);
        return X509.getRFCfromCert(this.hex);
    };
    this[B1S6.P7K] = function () {
        console['log']('Get NumSerie ',B1S6.P7K,w8,this[w8]);
