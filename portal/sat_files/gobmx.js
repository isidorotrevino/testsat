...
;window.Modernizr = function (e, t, n) {
    ...
    var r = "2.8.3", i = {}, s = !0, o = t.documentElement, u = "modernizr", a = t.createElement(u), f = a.style, l, c = {}.toString, h = {svg: "http://www.w3.org/2000/svg"}, p = {}, d = {}, v = {}, m = [], g = m.slice, y, b = function (e, n, r, i) {
        ...
        var r;
        return b("@media " + t + " { #" + u + " { position: absolute; } }", function (t) {
    ...
    for (var L in p)S(p, L) && (y = L.toLowerCase(), i[y] = p[L](), m.push((i[y] ? "" : "no-") + y));
    return i.addTest = function (e, t) {
        ...
        e.html5 = y, g(t)
    }(this, t), i._version = r, i.mq = w, i.testStyles = b, o.className = o.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + (s ? " js " + m.join(" ") : ""), i
    ...
    function E(e) {
        var t, n = e.getElementsByTagName("*"), r = n.length, i = RegExp("^(?:" + c().join("|") + ")$", "i"), s = [];
        while (r--)t = n[r], i.test(t.nodeName) && s.push(t.applyElement(S(t)));
        return s
    }

    function S(e) {
        var t, n = e.attributes, r = n.length, i = e.ownerDocument.createElement(b + ":" + e.nodeName);
        while (r--)t = n[r], t.specified && i.setAttribute(t.nodeName, t.nodeValue);
        return i.style.cssText = e.style.cssText, i
    }

    function x(e) {
        var t, n = e.split("{"), r = n.length, i = RegExp("(^|[\\s,>+~])(" + c().join("|") + ")(?=[[\\s,>+~#.:]|$)", "gi"), s = "$1" + b + "\\:$2";
    ...
    function N(e) {
        ...
        var t, n, r = h(e), i = e.namespaces, s = e.parentWindow;
        return !w || e.printShived ? e : (typeof i[b] == "undefined" && i.add(b), s.attachEvent("onbeforeprint", function () {
            o();
            var r, i, s, u = e.styleSheets, a = [], f = u.length, c = Array(f);
            while (f--)c[f] = u[f];
            while (s = c.pop())if (!s.disabled && y.test(s.media)) {
                try {
                    r = s.imports, i = r.length
                } catch (h) {
                    i = 0
                }
                for (f = 0; f < i; f++)c.push(r[f]);
                try {
                    a.push(s.cssText)
                } catch (h) {
                }
            }
            a = x(a.reverse().join("")), n = E(e), t = l(e, a)
        }), s.attachEvent("onafterprint", function () {
            T(n), clearTimeout(r._removeSheetTimer), r._removeSheetTimer = setTimeout(o, 500)
        }), e.printShived = !0, e)
    }
    ...
    e.html5 = g, m(t);
    var y = /^$|\b(?:all|print)\b/, b = "html5shiv", w = !f && function () {
    ...
    g.type += " print", g.shivPrint = N, N(t)
...
(function () {
    ...
    // var root = 'https://siatdev.sat.gob.mx/';
    //
